...
const Food = () => {
    ...
    const [deshType,setDeshType]=useState('lunch')
    ...
    useEffect(()=>{
        const newFoodList=foods?.filter(food=> food.deshType===deshType)
        setDisplayFood(newFoodList)
    },[foods,deshType])

    return (
        <Container className='my-4'>
          <FoodHeader setdeshtype={setDeshType}></FoodHeader>
          <div className="foods my-4">
            <Row xs={1} md={3} className="g-5">
                {
                    displayFood.map(foodItem => <FoodItem foodItem={foodItem}></FoodItem>)
                }
            </Row>
          </div>
        </Container>
...
// https://i.ibb.co/XtCFBwb/lunch2.png
// https://i.ibb.co/jbcNBcZ/lunch3.png
// https://i.ibb.co/yX3w7Fw/lunch4.png
// https://i.ibb.co/qDBDJ69/lunch5.png
// https://i.ibb.co/tPc46ZL/lunch6.png
// https://i.ibb.co/tKY7XNk/lunch1.png

// https://i.ibb.co/pK0YN9t/breakfast2.png
// https://i.ibb.co/h1vvWnq/breakfast3.png
// https://i.ibb.co/mJ6Fnw0/breakfast4.png
// https://i.ibb.co/ykb1Rxb/breakfast5.png
// https://i.ibb.co/2hBvTdb/breakfast6.png
// https://i.ibb.co/DLqVXpZ/breakfast1.png
...
// https://i.ibb.co/H75T3sc/dinner2.png
// https://i.ibb.co/gRWT31p/dinner3.png
// https://i.ibb.co/ZhzxFwQ/dinner4.png
// https://i.ibb.co/dfqtNMK/dinner5.png
// https://i.ibb.co/Wk5Fvxm/dinner6.png
// https://i.ibb.co/mtBfYSW/dinner1.png